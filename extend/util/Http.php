...
class Http
{
     ...
     * @return string
     */
    public static function httpGet(string $url, bool $isGzip = false): string
    {
        $curl = curl_init();
     ...
     * @return string
     */
    public static function httpPost(string $url, array $data, string $type = 'form', bool $isGzip = false): string
    {
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL, $url);
