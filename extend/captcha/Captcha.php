...
class Captcha
{
     ...
     * @return string
     */
    private function _getImage($guid)
    {
        // 图片宽(px)
        ...
        // 验证码使用随机字体
        $ttfPath = __DIR__ . DS . 'assets' . DS . ($this->useZh ? 'zhttfs' : 'ttfs') . DS;
    ...
    {
        $path = EXTEND_PATH . 'captcha' . DS . 'assets' . DS . 'bgs' . DS;
        $dir  = dir($path);
